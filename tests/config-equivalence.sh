...
EQUIV_FIELDS=(critic criticModel criticRubric verify maxRetries maxPrsPerDay maxOpenAutoIssues workScope implementer requiredLabels unattendedLabels requiredChecks maxActiveIssues maxTaskSeconds maxReviewBytes profileDir checkBackend requiredWorkflows)
